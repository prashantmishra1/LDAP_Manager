...
public class Manager {
	private static final String DEFAULT_LDAP_URL      = "localhost";
	private static final String DEFAULT_BASE_DN       = "ou=user,dc=system,dc=com";
	private static final String DEFAULT_BIND_USER     = "uid=admin,ou=system";
	private static final String DEFAULT_BIND_PASSWORD = "secret";
	...
	public JSONObject addUser(JSONObject input){
		...
		try {
			...
			String name = (String) input.get("displayName");
			
			connection.bind(DEFAULT_BIND_USER, DEFAULT_BIND_PASSWORD);
